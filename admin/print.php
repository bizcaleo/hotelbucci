...
@page { margin: 0; }
	...
	while($row=mysqli_fetch_array($re))
	{
		...
		$days = $row['noofdays'];
									...
									if($bed=="Single")
									{
										$type_of_bed = $type_of_room * 75/100;
									}
									else if($bed=="Double")
									{
										$type_of_bed = $type_of_room * 100/100;
									}
									else if($bed=="Triple")
									{
										$type_of_bed = $type_of_room * 100/100;
	...
	?>
		<header>
			<h1>Invoice</h1>
			<address >
				<p>BUCCI RISE HOTEL,</p>
				<p>Namanga rd<br>Kenya.</p>
				<p>0706355483</p>
			</address>
		</header>
		<article>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@buccirise.com || Web :- www.buccirise.com || Phone : 0706355483</p>
			</div>
		</aside>
	</body>
</html>
